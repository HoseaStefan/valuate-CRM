...
export default function LeaveDetailScreen() {
  ...
  const startDate = parseParam(params.startDate);
  const endDate = parseParam(params.endDate);
  const createdAt = parseParam(params.createdAt);
        ...
        <View style={styles.card}>
          <View style={styles.titleRow}>
            ...
            <View style={styles.titleText}>
              <Text style={styles.title}>{title || 'Pengajuan Cuti'}</Text>
              <Text style={styles.subtitle}>{subtitle || 'Cuti'}</Text>
            </View>
          </View>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{startDate && endDate ? `${formatDate(startDate)} - ${formatDate(endDate)}` : '-'}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Tanggal Pengajuan</Text>
            <Text style={styles.detailValue}>{createdAt ? formatDate(createdAt) : '-'}</Text>
          </View>
          <View style={styles.detailRow}>
